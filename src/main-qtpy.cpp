/*
  ...
  Assumes use of Adafruit QT Py ESP32-C3 board
...
// int WasherPin = A3;    // Washer Indicator NeoPixel pin
// int DryerPin = 10;     // Dryer Indicator NeoPixel pin
// int MiscPin = 8;       // Misc Indicator NeoPixel pin
int NeoPixelPin = 0; // Onboard NeoPixels pin
