...
Washing Machine status indicator using ESP32
...
- Uses commonly available ESP32 NodeMCU boards or other boards with identical pinout.
  - Not the similarly named **_ESP8266_** NodeMCU boards, which uses different chip and pinout.
  - Tested with [Inland/Microcenter ESP32 board](https://www.microcenter.com/product/613822/inland-esp32-wroom-32d-module).
  - Designs using 1206 SMT or through hole components available.
